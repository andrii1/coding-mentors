      ...
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-800 to-indigo-700" style="mix-blend-mode: multiply;"></div>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
      <nav className="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
        ...
        <div className="hidden md:flex md:space-x-10">
          ...
          <a href="#" className="font-medium text-gray-500 hover:text-gray-900"><Link to="/mentors">Mentors</Link></a>
      ...
      <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
        ...
        <div role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
          <div className="px-2 pt-2 pb-3" role="none">
            <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem"><Link to="/">Home</Link></a>

            <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem"><Link to="/about">About</Link></a>

            <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" role="menuitem"><Link to="/mentors">Mentors</Link></a>
    ...
    <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
      <div className="text-center">
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
          <span className="block xl:inline">Learn to code</span>
          <span className="block text-indigo-600 xl:inline"> faster</span>
        </h1>
        <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
          Find a coding mentor or become one.
          <Switch>
...
function About() {
  return (
    <div>
      <h2>About</h2>
      <p>Coding mentors helps you to learn coding faster. Find best mentors, subscribe for monthly mentorship or get on one-time classNameNamees.</p>
    </div>
  );
}
